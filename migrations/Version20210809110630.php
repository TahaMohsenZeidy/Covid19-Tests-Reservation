 ...
 */
final class Version20210809110630 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__place AS SELECT id, room, floor, kit, country, result, name FROM place');
        $this->addSql('DROP TABLE place');
        $this->addSql('CREATE TABLE place (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, room VARCHAR(255) NOT NULL COLLATE BINARY, floor VARCHAR(255) NOT NULL COLLATE BINARY, kit INTEGER NOT NULL, country VARCHAR(255) NOT NULL COLLATE BINARY, result VARCHAR(255) NOT NULL COLLATE BINARY, name VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO place (id, room, floor, kit, country, result, name) SELECT id, room, floor, kit, country, result, name FROM __temp__place');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_41AD8DDA3544AD9E ON medical_history_image (medical_history_id)');
        $this->addSql('CREATE INDEX IDX_41AD8DDA3DA5256D ON medical_history_image (image_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__place AS SELECT id, room, floor, name, kit, country, result FROM place');
        $this->addSql('DROP TABLE place');
        $this->addSql('CREATE TABLE place (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, room VARCHAR(255) NOT NULL, floor VARCHAR(255) NOT NULL, kit INTEGER NOT NULL, country VARCHAR(255) NOT NULL, result VARCHAR(255) NOT NULL, name VARCHAR(255) DEFAULT \'Sbitar\' NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO place (id, room, floor, name, kit, country, result) SELECT id, room, floor, name, kit, country, result FROM __temp__place');
        $this->addSql('DROP TABLE __temp__place');
        $this->addSql('DROP INDEX IDX_10C31F866B899279');
        $this->addSql('DROP INDEX IDX_10C31F862902E187');
        $this->addSql('DROP INDEX IDX_10C31F86ECAB15B3');
