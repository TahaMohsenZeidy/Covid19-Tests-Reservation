 ...
 */
final class Version20210802173858 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE patient ADD COLUMN enabled BOOLEAN NOT NULL DEFAULT FALSE ');
        $this->addSql('ALTER TABLE patient ADD COLUMN confirmation_token VARCHAR(40) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE __temp__medical_history');
        $this->addSql('CREATE INDEX IDX_61B890856B899279 ON medical_history (patient_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__patient AS SELECT id, firstname, lastname, identifier, birthdate, nationality, email, address, gsm, age, gender, roles, identifier_change_date FROM patient');
        ...
        $this->addSql('INSERT INTO patient (id, firstname, lastname, identifier, birthdate, nationality, email, address, gsm, age, gender, roles, identifier_change_date) SELECT id, firstname, lastname, identifier, birthdate, nationality, email, address, gsm, age, gender, roles, identifier_change_date FROM __temp__patient');
