 ...
 */
final class Version20210804090617 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__times AS SELECT id, place_id, time FROM times');
        ...
        $this->addSql('INSERT INTO times (id, place_id, time_begin) SELECT id, place_id, time FROM __temp__times');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_FC505645DA6A219 ON tester (place_id)');
        $this->addSql('DROP INDEX IDX_1DD7EE8CDA6A219');
        $this->addSql('CREATE TEMPORARY TABLE __temp__times AS SELECT id, place_id FROM times');
        $this->addSql('DROP TABLE times');
        ...
        $this->addSql('INSERT INTO times (id, place_id) SELECT id, place_id FROM __temp__times');
        $this->addSql('DROP TABLE __temp__times');
        $this->addSql('CREATE INDEX IDX_1DD7EE8CDA6A219 ON times (place_id)');
    }
}
