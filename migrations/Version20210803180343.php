 ...
 */
final class Version20210803180343 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__medical_history AS SELECT id, patient_id, disease, scan, analyse, medecine1, medecine2, medecine3, scan1, analyse1 FROM medical_history');
        $this->addSql('DROP TABLE medical_history');
        $this->addSql('CREATE TABLE medical_history (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, patient_id INTEGER NOT NULL, disease VARCHAR(255) DEFAULT NULL COLLATE BINARY, scan VARCHAR(255) DEFAULT NULL COLLATE BINARY, analyse VARCHAR(255) DEFAULT NULL COLLATE BINARY, medecine1 VARCHAR(255) DEFAULT NULL COLLATE BINARY, medecine2 VARCHAR(255) DEFAULT NULL COLLATE BINARY, medecine3 VARCHAR(255) DEFAULT NULL COLLATE BINARY, scan1 VARCHAR(255) DEFAULT NULL COLLATE BINARY, analyse1 VARCHAR(255) DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_61B890856B899279 FOREIGN KEY (patient_id) REFERENCES patient (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO medical_history (id, patient_id, disease, scan, analyse, medecine1, medecine2, medecine3, scan1, analyse1) SELECT id, patient_id, disease, scan, analyse, medecine1, medecine2, medecine3, scan1, analyse1 FROM __temp__medical_history');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__patient AS SELECT id, firstname, lastname, birthdate, nationality, email, address, age, gender, identifier, gsm, roles, identifier_change_date, enabled, confirmation_token FROM patient');
        $this->addSql('DROP TABLE patient');
        $this->addSql('CREATE TABLE patient (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, firstname VARCHAR(255) NOT NULL COLLATE BINARY, lastname VARCHAR(255) NOT NULL COLLATE BINARY, birthdate DATE NOT NULL, nationality VARCHAR(255) NOT NULL COLLATE BINARY, email VARCHAR(255) NOT NULL COLLATE BINARY, address VARCHAR(255) NOT NULL COLLATE BINARY, age INTEGER NOT NULL, gender VARCHAR(255) NOT NULL COLLATE BINARY, identifier VARCHAR(255) NOT NULL COLLATE BINARY, gsm VARCHAR(255) NOT NULL COLLATE BINARY, roles CLOB NOT NULL COLLATE BINARY --(DC2Type:simple_array)
        , identifier_change_date INTEGER DEFAULT NULL, confirmation_token VARCHAR(40) DEFAULT NULL COLLATE BINARY, enabled BOOLEAN NOT NULL)');
        $this->addSql('INSERT INTO patient (id, firstname, lastname, birthdate, nationality, email, address, age, gender, identifier, gsm, roles, identifier_change_date, enabled, confirmation_token) SELECT id, firstname, lastname, birthdate, nationality, email, address, age, gender, identifier, gsm, roles, identifier_change_date, enabled, confirmation_token FROM __temp__patient');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_61B890856B899279');
        $this->addSql('CREATE TEMPORARY TABLE __temp__medical_history AS SELECT id, patient_id, disease, medecine1, medecine2, medecine3, scan, scan1, analyse, analyse1 FROM medical_history');
        $this->addSql('DROP TABLE medical_history');
        $this->addSql('CREATE TABLE medical_history (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, patient_id INTEGER NOT NULL, disease VARCHAR(255) DEFAULT NULL, medecine1 VARCHAR(255) DEFAULT NULL, medecine2 VARCHAR(255) DEFAULT NULL, medecine3 VARCHAR(255) DEFAULT NULL, scan VARCHAR(255) DEFAULT NULL, scan1 VARCHAR(255) DEFAULT NULL, analyse VARCHAR(255) DEFAULT NULL, analyse1 VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO medical_history (id, patient_id, disease, medecine1, medecine2, medecine3, scan, scan1, analyse, analyse1) SELECT id, patient_id, disease, medecine1, medecine2, medecine3, scan, scan1, analyse, analyse1 FROM __temp__medical_history');
        $this->addSql('DROP TABLE __temp__medical_history');
        $this->addSql('CREATE INDEX IDX_61B890856B899279 ON medical_history (patient_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__patient AS SELECT id, firstname, lastname, identifier, birthdate, nationality, email, address, gsm, age, gender, roles, identifier_change_date, enabled, confirmation_token FROM patient');
        $this->addSql('DROP TABLE patient');
        $this->addSql('CREATE TABLE patient (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, identifier VARCHAR(255) NOT NULL, birthdate DATE NOT NULL, nationality VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, gsm VARCHAR(255) NOT NULL, age INTEGER NOT NULL, gender VARCHAR(255) NOT NULL, roles CLOB NOT NULL --(DC2Type:simple_array)
        , identifier_change_date INTEGER DEFAULT NULL, confirmation_token VARCHAR(40) DEFAULT NULL, enabled BOOLEAN DEFAULT NULL)');
        $this->addSql('INSERT INTO patient (id, firstname, lastname, identifier, birthdate, nationality, email, address, gsm, age, gender, roles, identifier_change_date, enabled, confirmation_token) SELECT id, firstname, lastname, identifier, birthdate, nationality, email, address, gsm, age, gender, roles, identifier_change_date, enabled, confirmation_token FROM __temp__patient');
        $this->addSql('DROP TABLE __temp__patient');
        $this->addSql('DROP INDEX IDX_10C31F866B899279');
        $this->addSql('DROP INDEX IDX_10C31F862902E187');
        $this->addSql('DROP INDEX IDX_10C31F86ECAB15B3');
