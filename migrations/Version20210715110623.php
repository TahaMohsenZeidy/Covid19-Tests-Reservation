 ...
 */
final class Version20210715110623 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__place AS SELECT id, tester_id, room, floor, kit, country, result FROM place');
        ...
        $this->addSql('INSERT INTO place (id, tester_id, room, floor, kit, country, result) SELECT id, tester_id, room, floor, kit, country, result FROM __temp__place');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__medical_history AS SELECT id, patient_id, disease, medecine_1, medecine_2, medecine_3, scan, scan_1, analyse, analyse_1 FROM medical_history');
        $this->addSql('DROP TABLE medical_history');
        $this->addSql('CREATE TABLE medical_history (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, disease VARCHAR(255) DEFAULT NULL, medecine_1 VARCHAR(255) DEFAULT NULL, medecine_2 VARCHAR(255) DEFAULT NULL, medecine_3 VARCHAR(255) DEFAULT NULL, scan VARCHAR(255) DEFAULT NULL, scan_1 VARCHAR(255) DEFAULT NULL, analyse VARCHAR(255) DEFAULT NULL, analyse_1 VARCHAR(255) DEFAULT NULL, patient_id INTEGER NOT NULL)');
        $this->addSql('INSERT INTO medical_history (id, patient_id, disease, medecine_1, medecine_2, medecine_3, scan, scan_1, analyse, analyse_1) SELECT id, patient_id, disease, medecine_1, medecine_2, medecine_3, scan, scan_1, analyse, analyse_1 FROM __temp__medical_history');
        $this->addSql('DROP TABLE __temp__medical_history');
        $this->addSql('CREATE INDEX IDX_61B890856B899279 ON medical_history (patient_id)');
        $this->addSql('DROP INDEX UNIQ_741D53CD979A21C1');
        $this->addSql('CREATE TEMPORARY TABLE __temp__place AS SELECT id, tester_id, room, floor, kit, country, result FROM place');
        $this->addSql('DROP TABLE place');
        $this->addSql('CREATE TABLE place (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, tester_id INTEGER DEFAULT NULL, room VARCHAR(255) NOT NULL, floor VARCHAR(255) NOT NULL, kit INTEGER NOT NULL, country VARCHAR(255) NOT NULL, result VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO place (id, tester_id, room, floor, kit, country, result) SELECT id, tester_id, room, floor, kit, country, result FROM __temp__place');
        $this->addSql('DROP TABLE __temp__place');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_741D53CD979A21C1 ON place (tester_id)');
        $this->addSql('DROP INDEX IDX_10C31F866B899279');
