 ...
 */
final class Version20210715103104 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__tester AS SELECT id, firstname, lastname, identifier, position, department FROM tester');
        ...
        $this->addSql('INSERT INTO tester (id, firstname, lastname, identifier, position, department) SELECT id, firstname, lastname, identifier, position, department FROM __temp__tester');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__tester AS SELECT id, firstname, lastname, identifier, position, department FROM tester');
        $this->addSql('DROP TABLE tester');
        $this->addSql('CREATE TABLE tester (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, identifier VARCHAR(255) NOT NULL, position VARCHAR(255) NOT NULL, department VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO tester (id, firstname, lastname, identifier, position, department) SELECT id, firstname, lastname, identifier, position, department FROM __temp__tester');
        $this->addSql('DROP TABLE __temp__tester');
        $this->addSql('DROP INDEX IDX_1DD7EE8CDA6A219');
        $this->addSql('CREATE TEMPORARY TABLE __temp__times AS SELECT id, place_id, time, date FROM times');
