 ...
 */
final class Version20210716112028 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE place (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, room VARCHAR(255) NOT NULL COLLATE BINARY, floor VARCHAR(255) NOT NULL COLLATE BINARY, kit INTEGER NOT NULL, country VARCHAR(255) NOT NULL COLLATE BINARY, result VARCHAR(255) NOT NULL COLLATE BINARY)');
        ...
        $this->addSql('CREATE TABLE tester (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, place_id INTEGER NOT NULL, firstname VARCHAR(255) NOT NULL COLLATE BINARY, lastname VARCHAR(255) NOT NULL COLLATE BINARY, identifier VARCHAR(255) NOT NULL COLLATE BINARY, position VARCHAR(255) NOT NULL COLLATE BINARY, department VARCHAR(255) NOT NULL COLLATE BINARY, CONSTRAINT FK_FC505645DA6A219 FOREIGN KEY (place_id) REFERENCES place (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE travel (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, rdv_id INTEGER NOT NULL, fly_date DATETIME NOT NULL, destination VARCHAR(255) NOT NULL COLLATE BINARY, CONSTRAINT FK_2D0B6BCE4CCE3F86 FOREIGN KEY (rdv_id) REFERENCES rdv (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO travel (id, fly_date, destination) SELECT id, fly_date, destination FROM __temp__travel');
        $this->addSql('DROP TABLE __temp__travel');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_2D0B6BCE4CCE3F86 ON travel (rdv_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__place AS SELECT id, room, floor, kit, country, result FROM place');
        $this->addSql('DROP TABLE place');
        $this->addSql('CREATE TABLE place (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, room VARCHAR(255) NOT NULL, floor VARCHAR(255) NOT NULL, kit INTEGER NOT NULL, country VARCHAR(255) NOT NULL, result VARCHAR(255) NOT NULL, tester_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO place (id, room, floor, kit, country, result) SELECT id, room, floor, kit, country, result FROM __temp__place');
        $this->addSql('DROP TABLE __temp__place');
        ...
        $this->addSql('DROP TABLE rdv');
        $this->addSql('CREATE TABLE rdv (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, symptomes_id INTEGER NOT NULL, travel_id INTEGER DEFAULT NULL, place_id INTEGER DEFAULT NULL, date DATETIME NOT NULL, result VARCHAR(255) NOT NULL, patient_id INTEGER DEFAULT NULL)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__tester AS SELECT id, place_id, firstname, lastname, identifier, position, department FROM tester');
        $this->addSql('DROP TABLE tester');
        $this->addSql('CREATE TABLE tester (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, identifier VARCHAR(255) NOT NULL, position VARCHAR(255) NOT NULL, department VARCHAR(255) NOT NULL, place_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO tester (id, place_id, firstname, lastname, identifier, position, department) SELECT id, place_id, firstname, lastname, identifier, position, department FROM __temp__tester');
        $this->addSql('DROP TABLE __temp__tester');
        $this->addSql('CREATE INDEX IDX_FC505645DA6A219 ON tester (place_id)');
        $this->addSql('DROP INDEX IDX_1DD7EE8CDA6A219');
        $this->addSql('CREATE TEMPORARY TABLE __temp__times AS SELECT id, place_id, time, date FROM times');
        $this->addSql('DROP TABLE times');
        $this->addSql('CREATE TABLE times (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, time DATETIME NOT NULL, date DATE NOT NULL, place_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO times (id, place_id, time, date) SELECT id, place_id, time, date FROM __temp__times');
        $this->addSql('DROP TABLE __temp__times');
        $this->addSql('CREATE INDEX IDX_1DD7EE8CDA6A219 ON times (place_id)');
        $this->addSql('DROP INDEX UNIQ_2D0B6BCE4CCE3F86');
        $this->addSql('CREATE TEMPORARY TABLE __temp__travel AS SELECT id, fly_date, destination FROM travel');
        $this->addSql('DROP TABLE travel');
        $this->addSql('CREATE TABLE travel (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, fly_date DATETIME NOT NULL, destination VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO travel (id, fly_date, destination) SELECT id, fly_date, destination FROM __temp__travel');
        $this->addSql('DROP TABLE __temp__travel');
    }
}
