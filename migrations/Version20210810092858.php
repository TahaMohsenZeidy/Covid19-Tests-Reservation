 ...
 */
final class Version20210810092858 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE medical_file (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, brochure_filename VARCHAR(255) DEFAULT NULL)');
