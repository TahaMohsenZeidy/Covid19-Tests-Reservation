 ...
 */
final class Version20210802164633 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__patient AS SELECT id, firstname, lastname, birthdate, nationality, email, address, age, gender, identifier, gsm, roles FROM patient');
        $this->addSql('DROP TABLE patient');
        $this->addSql('CREATE TABLE patient (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, firstname VARCHAR(255) NOT NULL COLLATE BINARY, lastname VARCHAR(255) NOT NULL COLLATE BINARY, birthdate DATE NOT NULL, nationality VARCHAR(255) NOT NULL COLLATE BINARY, email VARCHAR(255) NOT NULL COLLATE BINARY, address VARCHAR(255) NOT NULL COLLATE BINARY, age INTEGER NOT NULL, gender VARCHAR(255) NOT NULL COLLATE BINARY, identifier VARCHAR(255) NOT NULL COLLATE BINARY, gsm VARCHAR(255) NOT NULL COLLATE BINARY, roles CLOB NOT NULL --(DC2Type:simple_array)
        , identifier_change_date INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO patient (id, firstname, lastname, birthdate, nationality, email, address, age, gender, identifier, gsm, roles) SELECT id, firstname, lastname, birthdate, nationality, email, address, age, gender, identifier, gsm, roles FROM __temp__patient');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE __temp__medical_history');
        $this->addSql('CREATE INDEX IDX_61B890856B899279 ON medical_history (patient_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__patient AS SELECT id, firstname, lastname, identifier, birthdate, nationality, email, address, gsm, age, gender, roles FROM patient');
        $this->addSql('DROP TABLE patient');
        $this->addSql('CREATE TABLE patient (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, identifier VARCHAR(255) NOT NULL, birthdate DATE NOT NULL, nationality VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, gsm VARCHAR(255) NOT NULL, age INTEGER NOT NULL, gender VARCHAR(255) NOT NULL, roles CLOB DEFAULT \'ROLE_WRITER\' NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO patient (id, firstname, lastname, identifier, birthdate, nationality, email, address, gsm, age, gender, roles) SELECT id, firstname, lastname, identifier, birthdate, nationality, email, address, gsm, age, gender, roles FROM __temp__patient');
        $this->addSql('DROP TABLE __temp__patient');
        $this->addSql('DROP INDEX IDX_10C31F866B899279');
        $this->addSql('DROP INDEX IDX_10C31F862902E187');
        $this->addSql('DROP INDEX IDX_10C31F86ECAB15B3');
